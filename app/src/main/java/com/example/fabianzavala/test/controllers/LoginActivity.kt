/********************************************************************
 ** -----------------------------------------------------------------------------------------------
 ** Description: Class to add functionality to login
 **
 ** Change Log:
...
import com.example.fabianzavala.test.databinding.ActivityLoginBinding
import com.example.fabianzavala.test.viewModels.LoginViewModel
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.password.apply {
            ...
            binding.login.setOnClickListener {
                ...
                editor.apply()
                val intentLogin = Intent(context, EmployeesActivity::class.java)
    ...
    override fun onStart() {
        ...
        if(pref == "signin")
        {
            val intentLogin = Intent(this, EmployeesActivity::class.java)
            startActivity(intentLogin)
            finish()
        }
    }
